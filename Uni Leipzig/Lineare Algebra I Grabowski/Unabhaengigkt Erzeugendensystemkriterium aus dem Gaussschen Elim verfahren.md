# Satz
sei $\vec{v_{1}},..,\vec{v_{n}}\in \mathbb{K}^{m}$
...
Die vektoren $\vec{v_{i}}$ sind ein [[Vektorraum#Erzeugendensystem|Erzeugendensystem]]  gdw es ein [[Zeilenstufenform#Pivot|Pivot]] in jeder Zeile von $B$ gibt.
...
## Satz
Falls $v_{1},\dots,v_{n}\in \mathbb{K}^{n}$ eine [[Vektorraum|Basis]], dann $m=n$


## Satz (allgemeinere Version der vorherigen Sätze)
