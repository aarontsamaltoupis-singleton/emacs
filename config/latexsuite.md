[
    // eigene snippets
    //umlaute
    {trigger: ";a", replacement: "ä", options: "A"},
    {trigger: ";A", replacement: "Ä", options: "A"},

    {trigger: ";o", replacement: "ö", options: "A"},
    {trigger: ";O", replacement: "Ö", options: "A"},

           {trigger: ";u", replacement: "ü", options: "A"},
    {trigger: ";U", replacement: "Ü", options: "A"},

    {trigger: ";ss", replacement: "ß", options: "A"},
...
//{trigger: "\\b(-?\\d*\\.?\\d+)\\b(\\s|,|\\.\\s)", replacement: "$\\hspace{0pt}[[0]]$[[1]]", options: "rtA", description: "Automatically convert numbers to math"},
	...
	{trigger: "sq", replacement: "\\sqrt[$0]{ $1 }$2", options: "mA"},
    ...
    {trigger: "limits", replacement: "\\limits_{ ${0:n} \\to ${1:\\infty} } $2", options: "mA"},
